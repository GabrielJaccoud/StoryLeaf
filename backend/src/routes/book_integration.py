...
@book_integration_bp.route('/api/books/list', methods=['GET'])
...
@book_integration_bp.route('/api/books/<book_id>/content', methods=['GET'])
...
@book_integration_bp.route('/api/books/<book_id>/world-data', methods=['GET'])
...
@book_integration_bp.route('/api/books/<book_id>/audiobook-data', methods=['GET'])
...
@book_integration_bp.route('/api/books/<book_id>/ai-analysis', methods=['POST'])
